...
#version 3 Broke out android review by rating. Identified that 2 stars and below had negative sentiment, 3 starts had mixed but mostly positive and 4+ had positive sentiment.
#Todo:
##1. Fix word Cloud
##2. Identify App with best average rating as "leader"
##2. Identify Scotiabank, analysis
##3. Idnetify RBC and TD. How does this compare to Scotia? 

ibrary(qdap) #replace_contraction
...
#split data by review for analysis at each level
...
#combine 1&2 as "bad review" and combine 3,4,&5 as "good" reviews
rv_android12 = smartbind(rv_android1, rv_android2)
rv_android345 = smartbind(rv_android3, rv_android4, rv_android5)
rv_android45 = smartbind(rv_android4, rv_android5)
reviews_all = review_all
review_all = rv_android45
#=======================#
#***MODEL DEVELOPMENT***#
#=======================#
...
stats = stats[!grepl("в", stats$keyword),]
stats = stats[!grepl("г", stats$keyword),]
